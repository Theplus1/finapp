...
export const CUSTOMER_API_ROLES = ['boss', 'ads', 'accountant', 'employee'] as const satisfies readonly AdminUserRole[];
export const CARDS_API_ROLES = ['boss', 'ads', 'employee'] as const satisfies readonly AdminUserRole[];
export const BOSS_ONLY_ROLES = ['boss'] as const satisfies readonly AdminUserRole[];
export const BOSS_AND_ACCOUNTANT_ROLES = ['boss', 'accountant', 'employee'] as const satisfies readonly AdminUserRole[];
